...
describe('HackerNews Api', () => {
  ...
  describe('getStory functionality', () => {
    it('requests and gets a story from the hacker news api', async () => {
    ...
    it('does not retrieve a story from the hacker news api, but handles gracefully', async () => {
      axios.get.mockImplementation(() =>
  ...
  describe('getStoryIds functionality', () => {
    it('requests and gets story ids from the hacker news api', async () => {
